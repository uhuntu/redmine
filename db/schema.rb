...
ActiveRecord::Schema.define(version: 2020_08_26_153402) do
  ...
  create_table "easy_entity_assignments", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
  ...
  create_table "easy_settings", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.string "type"
    t.string "name"
    t.text "value"
